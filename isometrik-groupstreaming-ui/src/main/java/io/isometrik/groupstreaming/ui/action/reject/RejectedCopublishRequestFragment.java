package io.isometrik.groupstreaming.ui.action.reject;
...
public class RejectedCopublishRequestFragment extends BottomSheetDialogFragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    if (view == null) {
      ...
      view = inflater.inflate(R.layout.ism_bottomsheet_rejected_copublish, container, false);
    } else {

      if (view.getParent() != null) ((ViewGroup) view.getParent()).removeView(view);
    }
    ButterKnife.bind(this, view);
    tvRejectedHeading.setText(getString(R.string.ism_copublish_rejected_heading, userName));
    try {
