 ...
 * implemented by
 * the
 * ScrollableStreamsPresenter{@link ScrollableStreamsPresenter} and
 * ScrollableStreamsActivity{@link ScrollableStreamsActivity} respectively.
 *
 * @see ScrollableStreamsPresenter
 * @see ScrollableStreamsActivity
 */
public interface ScrollableStreamsContract {

  /**
   * The interface ScrollableStreamsContract.Presenter to be implemented by
   * ScrollableStreamsPresenter{@link
   * ScrollableStreamsPresenter}
   *
   * @see ScrollableStreamsPresenter
   */
  interface Presenter {
  ...
  /**
   * The interface ScrollableStreamsContract.View to be implemented by
   * ScrollableStreamsActivity{@link
   * ScrollableStreamsActivity}
   *
   * @see ScrollableStreamsActivity
   */
  interface View {
