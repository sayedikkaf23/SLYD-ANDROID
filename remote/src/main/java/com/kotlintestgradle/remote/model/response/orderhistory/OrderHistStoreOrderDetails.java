...
public class OrderHistStoreOrderDetails implements Parcelable, ValidItem {
  ...
  @SerializedName("storeRattingData")
  private StoreRatingDetails storeRattingData;
  @SerializedName("driverRattingData")
  private StoreRatingDetails driverRattingData;
  ...
  protected OrderHistStoreOrderDetails(Parcel in) {
    ...
    driverRattingData = in.readParcelable(StoreRatingDetails.class.getClassLoader());
    storeRattingData = in.readParcelable(StoreRatingDetails.class.getClassLoader());
  }
  ...
  public void writeToParcel(Parcel dest, int flags) {
    ...
    dest.writeParcelable(storeRattingData, flags);
    dest.writeParcelable(driverRattingData, flags);
  }
  ...
  public StoreRatingDetails getStoreRattingData() {
    return storeRattingData;
  }

  public void setStoreRattingData(StoreRatingDetails storeRattingData) {
    this.storeRattingData = storeRattingData;
  }

  public StoreRatingDetails getDriverRattingData() {
    return driverRattingData;
  }

  public void setDriverRattingData(StoreRatingDetails driverRattingData) {
    this.driverRattingData = driverRattingData;
  }
