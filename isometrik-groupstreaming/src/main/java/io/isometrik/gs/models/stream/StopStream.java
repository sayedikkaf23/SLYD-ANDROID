 ...
 * io.isometrik.gs.builder.stream.StopStreamQuery} request and parse the response(both success or
 * error) to return stop stream result StopStreamResult{@link io.isometrik.gs.response.stream.StopStreamResult}
 * or error received.
 *
...
public class StopStream {
  ...
  public void validateParams(@NotNull StopStreamQuery stopStreamQuery,
    ...
    String createdBy = stopStreamQuery.getCreatedBy();
