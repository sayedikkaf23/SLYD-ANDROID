 ...
 * io.isometrik.gs.builder.member.LeaveMemberQuery} request and parse the response(both success or
 * error) to return leave member result LeaveMemberResult{@link io.isometrik.gs.response.member.LeaveMemberResult}
 * or error received.
 *
...
public class LeaveMember {
  ...
  public void validateParams(@NotNull LeaveMemberQuery leaveMemberQuery,
    ...
    String memberId = leaveMemberQuery.getMemberId();
    ...
    if (streamId == null || streamId.isEmpty()) {
      ...
      Call<LeaveMemberResult> call = retrofitManager.getMemberService()
          .leaveMember(headers, imConfiguration.getAccountId(), imConfiguration.getProjectId(),
              imConfiguration.getKeysetId(), streamId, memberId);
