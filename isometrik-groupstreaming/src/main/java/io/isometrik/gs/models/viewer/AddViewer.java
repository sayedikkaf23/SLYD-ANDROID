 ...
 * io.isometrik.gs.builder.viewer.AddViewerQuery} request and parse the response(both success or
 * error) to return add viewer result AddViewerResult{@link io.isometrik.gs.response.viewer.AddViewerResult}
 * or error received.
 *
...
public class AddViewer {
  ...
  public void validateParams(@NotNull AddViewerQuery addViewerQuery,
    ...
    String viewerId = addViewerQuery.getViewerId();
