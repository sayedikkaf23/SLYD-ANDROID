 ...
 * io.isometrik.gs.builder.stream.UpdateUserPublishingStatusQuery} request and parse the
 * response(both success or error) to return update user publishing status result
 * UpdateUserPublishingStatusResult{@link io.isometrik.gs.response.stream.UpdateUserPublishingStatusResult}
 * or error received.
 *
...
public class UpdateUserPublishStatus {
  ...
  public void validateParams(
    ...
    String userId = updateUserPublishingStatusQuery.getUserId();
    ...
    if (userId == null || userId.isEmpty()) {
      ...
      Call<UpdateUserPublishingStatusResult> call =
          retrofitManager.getStreamService().updateUserPublishingStatus(headers, body);
