 ...
 * io.isometrik.gs.builder.member.RemoveMemberQuery} request and parse the response(both success or
 * error) to return remove member result RemoveMemberResult{@link io.isometrik.gs.response.member.RemoveMemberResult}
 * or error received.
 *
...
public class RemoveMember {
  ...
  public void validateParams(@NotNull RemoveMemberQuery removeMemberQuery,
    ...
    String initiatorId = removeMemberQuery.getInitiatorId();
    ...
    if (streamId == null || streamId.isEmpty()) {
      ...
      Call<RemoveMemberResult> call = retrofitManager.getMemberService()
          .removeMember(headers, imConfiguration.getAccountId(), imConfiguration.getProjectId(),
              imConfiguration.getKeysetId(), streamId, initiatorId, memberId);
