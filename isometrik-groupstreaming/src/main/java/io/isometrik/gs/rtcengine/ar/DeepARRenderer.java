...
/**
 * The class to process frame received.
 */
public class DeepARRenderer implements GLSurfaceView.Renderer {
  ...
  private final String vertexShaderCode =
      "attribute vec4 vPosition;" + "attribute vec2 vUv;" + "varying vec2 uv; " +
  ...
  private boolean streamingInProgress = false;
  private EGLContext mEGLCurrentContext;
  private int textureWidth;
  private int textureHeight;

  /**
   * Instantiates a new DeepARRenderer.
   *
   * @param deepAR the deep ar engine
   * @param rtcEngine the rtc engine
   * @see ai.deepar.ar.DeepAR
  ...
  public void onSurfaceChanged(GL10 gl, final int width, final int height) {
    ...
    GLES20.glTexImage2D(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, 0, GLES20.GL_RGBA, textureWidth,
        textureHeight, 0, GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE, null);
  ...
  /**
   * Sets streaming in progress.
   *
   * @param streamingInProgress the streaming in progress
   */
  public void setStreamingInProgress(boolean streamingInProgress) {
    this.streamingInProgress = streamingInProgress;
  }

  /**
   * The class MyContextFactory.
   */
  public static class MyContextFactory implements GLSurfaceView.EGLContextFactory {
    ...
    /**
     * Instantiates a new My context factory.
     *
