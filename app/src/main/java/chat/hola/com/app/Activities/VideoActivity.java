...
//        Uri mp4VideoUri = Uri.parse("http://res.cloudinary.com/howdoo/video/upload/v1525965869/mrpkkc51tykbndpraqmf.mp4"); //Radnom 540p indian channel
...
//
////FOR LIVESTREAM LINK:
//        MediaSource videoSource = new ExtractorMediaSource(mp4VideoUri, dataSourceFactory, extractorsFactory, null, null);//mp4VideoUri, dataSourceFactory, 1, null, null);
