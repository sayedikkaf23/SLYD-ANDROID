 ...
 * </p>
 * <p>
 * There are two styles of MQTT client, this one and
 * <ul>
 ...
 * For more details on the blocking client see</p>
 * <p>
 ...
 * 			public void onStreamSubscribed(IMqttToken asyncActionToken) {
 * 				log("Connected");
 *            }
 * <p>
...
public interface IMqttAsyncClient {
     ...
     * <p>The default options are specified in {@link org.eclipse.paho.client.mqttv3.MqttConnectOptions} class.
     * </p>
     *
     ...
     * It is recommended to call prior to
