...
public class Query {
    ...
    /* package */ Query(Database database, View view) {
        ...
        allDocsMode = Query.AllDocsMode.ALL_DOCS;
    }
   ...
   private  Object getStartKey() {
    ...
    @InterfaceAudience.Public
    private String getStartKeyDocId() {
    ...
    @InterfaceAudience.Public
    private Query.IndexUpdateMode getIndexUpdateMode() {
    ...
    @InterfaceAudience.Public
    private Query.AllDocsMode getAllDocsMode() {
        return allDocsMode;
    }
    ...
    @InterfaceAudience.Public
    private int getPrefixMatchLevel() {
    ...
    @InterfaceAudience.Public
    private Predicate<QueryRow> getPostFilter() {
        return postFilter;
    }
    ...
    public boolean shouldIncludeDeleted() {
        return allDocsMode == Query.AllDocsMode.INCLUDE_DELETED;
    }

    @InterfaceAudience.Public
    public void setIncludeDeleted(boolean includeDeletedParam) {
        allDocsMode = (includeDeletedParam) ? Query.AllDocsMode.INCLUDE_DELETED : Query.AllDocsMode.ALL_DOCS;
    }
     ...
     */
    @InterfaceAudience.Public
    public Future runAsync(final Query.QueryCompleteListener onComplete) {
     ...
     */
    @InterfaceAudience.Private
    Future runAsyncInternal(final Query.QueryCompleteListener onComplete) {
