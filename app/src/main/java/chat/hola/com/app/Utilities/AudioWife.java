...
public class AudioWife {
    ...
    private void updatePlaytime(int currentTime) {
        ...
        playbackStr.append(String.format(Locale.US,"%02d:%02d", TimeUnit.MILLISECONDS.toMinutes((long) currentTime), TimeUnit.MILLISECONDS.toSeconds((long) currentTime) - TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes((long) currentTime))));
        ...
        if (totalDuration != 0) {
            playbackStr.append(String.format(Locale.US,"%02d:%02d", TimeUnit.MILLISECONDS.toMinutes((long) totalDuration), TimeUnit.MILLISECONDS.toSeconds((long) totalDuration) - TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes((long) totalDuration))));
        } else {
...
try{
        setTotalTime();}catch(IllegalArgumentException e){e.printStackTrace();}
        return this;
    }
...
//     * player provided by this method
//     * <br/>
//     * <br/>
