...
public class TabCameraActivity extends DaggerAppCompatActivity
        implements CameraStreamContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_tabs);
        ...
        if (isRecord) {
            ...
            try {
                ...
                if (audioFile != null) {
                    ...
                    mmr.setDataSource(TabCameraActivity.this, uri);
        ...
        cross.setOnClickListener(view -> {
            ...
            if (flowLayout.getChildCount() > 0) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(TabCameraActivity.this);
        ...
        selectSound.setOnClickListener(view -> {
            ...
            startActivityForResult(
                    new Intent(TabCameraActivity.this, DubCategoryActivity.class).putExtra("requestType",
    ...
    private void sendVideo() {
        ...
        if (speedChangedVideo != null) {
            ...
            if (audioSelected) {
                ...
                Intent intent = new Intent(TabCameraActivity.this, PreviewVideoActivity.class);
    ...
    private void requestCameraPermission() {
        ...
        if (ActivityCompat.checkSelfPermission(TabCameraActivity.this, Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED) {

            permissionsRequired.add(Manifest.permission.CAMERA);
        }
        if (ActivityCompat.checkSelfPermission(TabCameraActivity.this, Manifest.permission.RECORD_AUDIO)
                != PackageManager.PERMISSION_GRANTED) {

            permissionsRequired.add(Manifest.permission.RECORD_AUDIO);
        }
        if (ActivityCompat.checkSelfPermission(TabCameraActivity.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(TabCameraActivity.this, getString(R.string.dubsound_cancel),
            ...
            if (mediaPath == null) {
                ...
                if (mime != null && !mime.contains("image")) {
                    ...
                    if (duration > 0 && duration <= (MAXIMUM_RECORDING_LENGTH_ALLOWED * 1000)) {
                        ...
                        Intent intent = new Intent(TabCameraActivity.this, PreviewGalleryVideoActivity.class);
                        intent.putExtra("videoArray", recordedVideosList);
            ...
            if (dubbingStarted) {
                if (audioSelected) {
                    if (speed == 1) {
                        ...
                        player = MediaPlayer.create(TabCameraActivity.this, Uri.parse(audioFile));
    ...
    public void updateRecordingUI() {
        ...
        if (speed == 1) {
            ...
            runOnUiThread(() -> {
                ...
                View view = new View(TabCameraActivity.this);
    ...
    private void validateCameraPermissions() {
        ...
        if (ActivityCompat.checkSelfPermission(TabCameraActivity.this, Manifest.permission.CAMERA)
                == PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(TabCameraActivity.this,
    ...
    public void updateProgressBar(boolean start) {
        ...
        if (start) {
            ...
            if (captureEndTime - captureStartTime > 1000) {
                ...
                Toast.makeText(TabCameraActivity.this, getString(R.string.record_small_duration),
                        Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void startVideoCapture() {
        ...
        captureButton.setColorFilter(
                ContextCompat.getColor(TabCameraActivity.this, R.color.doodle_color_red),
    ...
    private void captureBitmap(final TabCameraActivity.BitmapReadyCallbacks bitmapReadyCallbacks) {
        if (sampleGLView != null) {
            sampleGLView.queueEvent(() -> {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    ...
                    try {
                        ...
                        Toast.makeText(TabCameraActivity.this, getString(R.string.string_17),
                                Toast.LENGTH_SHORT).show();
                    }
                } else {
            ...
            Toast.makeText(TabCameraActivity.this, getString(R.string.string_17), Toast.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    private View.OnTouchListener handleTouch = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent event) {
            ...
            if (GPUCameraRecorder != null) {
                        ...
                        if (!onlyPhotoCanBeCaptured) {
                            ...
                            if (audioSelected) {
                                ...
                                if (totalCapturedLength < selectedAudioDurationInSecs) {
                                    ...
                                    Toast.makeText(TabCameraActivity.this, R.string.dubbing_max_size,
                                            Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                ...
                                if (totalCapturedLength < MAXIMUM_RECORDING_LENGTH_ALLOWED) {
                                    ...
                                    Toast.makeText(TabCameraActivity.this, R.string.recording_max_size,
                                            Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                                        ...
                                        public void run() {
                                            ...
                                            if (alreadyTriedTimes < maxRetries) {
                                                ...
                                                runOnUiThread(() -> {
                                                    ...
                                                    Toast.makeText(TabCameraActivity.this,
                ...
                Toast.makeText(TabCameraActivity.this, getString(R.string.preparing_camera),
                        Toast.LENGTH_SHORT).show();
            }
            return true;
        }
            ...
            mStartCountDownCapture.setOnClickListener(v -> {
                ...
                if (audioSelected) {
                    ...
                    if (totalCapturedLength < selectedAudioDurationInSecs) {
                        ...
                        Toast.makeText(TabCameraActivity.this, R.string.dubbing_max_size, Toast.LENGTH_SHORT)
                                .show();
                    }
                } else {
                    ...
                    if (totalCapturedLength < MAXIMUM_RECORDING_LENGTH_ALLOWED) {
                        ...
                        Toast.makeText(TabCameraActivity.this, R.string.recording_max_size, Toast.LENGTH_SHORT)
                                .show();
                    }
                }
            });
    ...
    private void setupFilterView() {
        ...
        filtersList.addOnItemTouchListener(
                new RecyclerItemClickListener(TabCameraActivity.this, filtersList,
    ...
    private void startCountDownTimer() {
        ...
        if (message == null) {
            ...
            Toast.makeText(TabCameraActivity.this, message, Toast.LENGTH_SHORT).show();
        }
    }
}
