...
public class AROperations {
  ...
  public AROperations(DeepAR deepAR) {
    this.deepAR = deepAR;
    masks = new ArrayList<>();
     ...
     * /*Bug Id-DUBAND023
     * /*Fix Description-Remove heart and fire effects from list
   ...
   * @see chat.hola.com.app.DublyCamera.deepar.ar.AREffect
   */
  ...
  public void applyBeautifyOptions(boolean enable) {
    ...
    if (enable) {
      if (FiltersConfig.DOWNLOAD_REQUIRED) {
        ...
        applyFilter("beautify", "file:///android_asset/deepar/beauty");
      }
    } else {

      applyFilter("beautify", "none");
    }
  }
