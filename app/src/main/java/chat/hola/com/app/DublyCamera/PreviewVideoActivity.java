...
public class PreviewVideoActivity extends AppCompatActivity
  ...
  public void next() {
    ...
    if (checkIfFiltersAppliedOnAnyVideoSegment()) {
      ...
      progressDialog = new ProgressDialog(PreviewVideoActivity.this);
  ...
  public void filters() {
    if (filterEnabled) {
      ...
      Toast.makeText(PreviewVideoActivity.this, getString(R.string.select_segment_colorfilter),
  ...
  private void initializeViewForColorFiltersVideo() {
    ...
    view_filter.setOnTouchListener(new OnSwipeTouchListener(PreviewVideoActivity.this) {
  ...
  private void addMediaToBePlayed(String url, int durationInMs, ProgressBarModel progressBarModel) {
    ...
    if (progressBarModel.isFilterSelected()) {
      ...
      gpuPlayerView.setGlFilter(FilterType.createGlFilter(progressBarModel.getSelectedGlFilter(),
          PreviewVideoActivity.this));
    } else {

      gpuPlayerView.setGlFilter(
          FilterType.createGlFilter(filterItems.get(0).getFilterType(), PreviewVideoActivity.this));
    }
  ...
  private void startPlayback() {
    try {
      ...
      if (audioFile != null) {
        player = MediaPlayer.create(PreviewVideoActivity.this, Uri.parse(audioFile));
  ...
  private void prepareVideoPlaybackFiles(int maximumDuration) {
    ...
    rvProgressBars.addOnItemTouchListener(
        new RecyclerItemClickListener(PreviewVideoActivity.this, rvProgressBars,
    ...
    if (progressBarModel.isFilterSelected()) {
      ...
      if (progressBarModel.getFilterColor().isEmpty()) {
        applyVideoFilter(FilterType.createGlFilter(progressBarModel.getSelectedGlFilter(),
            PreviewVideoActivity.this), progressBarModel.getVideoPath(), positionOfVideo, true,
            null, true, "");
      } else {
  ...
  private void setupFilterView() {
    ...
    filtersList.addOnItemTouchListener(
        new RecyclerItemClickListener(PreviewVideoActivity.this, filtersList,
            new RecyclerItemClickListener.OnItemClickListener() {
              @Override
              public void onItemClick(View view, final int position) {
                if (gpuPlayerView != null) {
  ...
  public void updateFiltersVisibility() {
    if (filterEnabled) {
      ...
      Toast.makeText(PreviewVideoActivity.this, getString(R.string.select_segment_videofilter),
          Toast.LENGTH_SHORT).show();
    }
  }
