...
public class CustomBottomNavigationView extends BottomNavigationView {
  ...
  public void setTextVisibility(boolean visibility) {
    ...
    if (!visibility) {
      ...
      if (!visibilityHeightRecord) return;
      // restore mItemHeight
  ...
  public void setCurrentItem(int item) {
    ...
    OnClickListener mOnClickListener =
        getField(mMenuView.getClass(), mMenuView, "mOnClickListener");
  ...
  public OnNavigationItemSelectedListener getOnNavigationItemSelectedListener() {
    ...
    OnNavigationItemSelectedListener mListener =
        getField(BottomNavigationView.class, this, "mSelectedListener");
    return mListener;
  }
  ...
  private BottomNavigationMenuView getBottomNavigationMenuView() {
    if (null == mMenuView) mMenuView = getField(BottomNavigationView.class, this, "mMenuView");
    return mMenuView;
  }
   ...
   * necessary calls back to the provided {@link CustomBottomNavigationView} so that the tab
   * position is
   * kept in sync.
   * <p>
  ...
  private static class BottomNavigationViewExOnPageChangeListener
    ...
    public void onPageSelected(final int position) {
      ...
      if (null != bnve) bnve.setCurrentItem(position);
  ...
  private static class MyOnNavigationItemSelectedListener
    ...
    MyOnNavigationItemSelectedListener(ViewPager viewPager, CustomBottomNavigationView bnve,
        boolean smoothScroll, OnNavigationItemSelectedListener listener) {
