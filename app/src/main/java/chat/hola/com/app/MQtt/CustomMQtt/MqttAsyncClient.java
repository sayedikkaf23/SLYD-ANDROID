...
public class MqttAsyncClient implements IMqttAsyncClient { // DestinationProvider {
     ...
     * For example:
     * <ul>
     * <li><code>tcp://localhost:2053</code></li>
...
//				}
            ...
            case MqttConnectOptions.URI_TYPE_WS:
                ...
                //netModule = new WebSocketNetworkModule(factory, address, host, port, clientId,new Properties());
            ...
            case MqttConnectOptions.URI_TYPE_WSS:
                ...
                // Create the network module...
                //netModule = new WebSocketSecureNetworkModule((SSLSocketFactory) factory, address, host, port, clientId, new Properties());
     ...
     * <ul>
     * <li>{@link org.eclipse.paho.client.mqttv3.MqttAsyncClient#(String, MqttMessage, MqttDeliveryToken)} to publish a message in a non-blocking manner or
     * <li> to publish a message in a blocking manner
     * </ul>
     * </p>
        ...
        try {
            connect(this.connOpts, this.userContext, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    AppController.getInstance().updateReconnected();
                }
    ...
    private void startReconnectCycle() {
        ...
        reconnectTimer.schedule(new MqttAsyncClient.ReconnectTask(), reconnectDelay);
    }
