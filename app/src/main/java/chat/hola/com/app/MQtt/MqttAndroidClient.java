...
import chat.hola.com.app.MQtt.CustomMQtt.IMqttAsyncClient;
import chat.hola.com.app.MQtt.CustomMQtt.IMqttDeliveryToken;
import chat.hola.com.app.MQtt.CustomMQtt.IMqttMessageListener;
...
public class MqttAndroidClient extends BroadcastReceiver implements
    ...
    private static final String SERVICE_NAME = ApiOnServer.MQTT_SERVICE_PATH;
//    private static final String SERVICE_NAME = "chat.hola.com.howdoo.MQtt.MqttService";
     ...
     * @see (org.eclipse.paho.client.mqttv3.MqttConnectOptions, Object, org.eclipse.paho.client.mqttv3.IMqttActionListener)
     */
    @Override
...
//                serviceStartIntent.setAction(Constants.ACTION_START_FOURGROUND);
//                service = myContext.startForegroundService(serviceStartIntent);
//            }
//            else {
//                service = myContext.startService(serviceStartIntent);
//            }
            JobIntentService.enqueueWork(myContext, MqttService.class, 1, serviceStartIntent);
          //  if (service == null) {
...
//            }
     ...
     * token will be passed to any callback that has been set.
     * @throws org.eclipse.paho.client.mqttv3.MqttPersistenceException when a problem occurs storing the message
    ...
    /**
     * These all are the dummy methods
     */


    // STUB
    @Override
    public void setManualAcks(boolean set) {
    ...
    @Override
    public IMqttToken subscribe(String topic, int qos, Object userContext,
                                IMqttActionListener callback, IMqttMessageListener arr) throws MqttException {
        IMqttToken token = new MqttTokenAndroid(this, userContext,
                callback, new String[]{topic});
        String activityToken = storeToken(token);
        mqttService.subscribe(clientHandle, topic, qos, null, activityToken);
    ...
    // STUB
    @Override
    public IMqttToken subscribe(String topic, int qos, IMqttMessageListener arr) throws MqttException {
        IMqttToken token = new MqttTokenAndroid(this, null,
                null, new String[]{topic});
        String activityToken = storeToken(token);
        mqttService.subscribe(clientHandle, topic, qos, null, activityToken);
        return token;
    }
    ...
    // STUB
    @Override
    public void messageArrivedComplete(int a, int b) throws MqttException {
