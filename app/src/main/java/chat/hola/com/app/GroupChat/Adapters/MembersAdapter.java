...
//    private Typeface tf;
     ...
     */
    public MembersAdapter(Context mContext, ArrayList<Forward_ContactItem> mListData) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v1 = inflater.inflate(R.layout.gc_select_member, viewGroup, false);
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (mContext != null) {
                    ((CreateGroup) mContext).showNoSearchResults(constraint, mFilteredListData.size() == mOriginalListData.size());
                }
