package chat.hola.com.app.cameraActivities.ui;
...
import chat.hola.com.app.cameraActivities.ui.preview.PreviewActivity;
import chat.hola.com.app.cameraActivities.ui.view.CameraControlPanel;
import chat.hola.com.app.cameraActivities.ui.view.CameraSwitchView;
import chat.hola.com.app.cameraActivities.ui.view.FlashSwitchView;
import chat.hola.com.app.cameraActivities.ui.view.MediaActionSwitchView;
import chat.hola.com.app.cameraActivities.ui.view.RecordButton;
...
public abstract class BaseSandriosActivity<CameraId> extends SandriosCameraActivity<CameraId>
        ...
        CameraSwitchView.OnCameraTypeChangeListener, CameraControlPanel.SettingsClickListener, CameraControlPanel.PickerItemClickListener, TextEditingListener, TextEditorDialogFragment.OnTextLayerCallback {
    ...
    private boolean closeCameraView = false;
    Size size;
    View cameraPreview;
    boolean isCameraViewCleared;
...
//    }
    ...
    View getUserContentView(LayoutInflater layoutInflater, ViewGroup parent) {
        ...
        if (cameraControlPanel != null) {
            ...
            cameraControlPanel.setTextEditingListener(this);
...
//        Toast.makeText(this, "Videooo", Toast.LENGTH_SHORT).show();

//        startPreviewActivity();

        sendVideo(getCameraController().getOutputFile().toString());
    }
...
//        getCameraController().onDestroy();
        ...
        cameraControlPanel.openImageEditting(this, getMediaAction(), getCameraController().getOutputFile().toString());
    ...
    public void textChanged(@NonNull String text) {
        cameraControlPanel.onTextChanged(text);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            } else if (requestCode == cameraControlPanel.SELECT_STICKER_REQUEST_CODE) {
                cameraControlPanel.onStickerSelectActivityResult(data);
            }
        }
    }
