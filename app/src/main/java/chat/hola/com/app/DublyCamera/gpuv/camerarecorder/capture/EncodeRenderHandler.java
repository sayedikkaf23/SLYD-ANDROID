package chat.hola.com.app.DublyCamera.gpuv.camerarecorder.capture;
...
import chat.hola.com.app.DublyCamera.gpuv.egl.GlFramebufferObject;
import chat.hola.com.app.DublyCamera.gpuv.egl.GlPreview;
...
//        Log.d(TAG, "fileAspect:" + (fileHeight / fileWidth) + " viewAcpect: " + viewAspect);
...
//                Log.d(TAG, "cameraAspect: " + viewAspect + " YMatrixScale :" + YMatrixScale);
            } else {
                XMatrixScale = (flipHorizontal ? -1 : 1) * (fileAspect / viewAspect);
                YMatrixScale = (flipVertical ? -1 : 1);
//                Log.d(TAG, "cameraAspect: " + viewAspect + " YMatrixScale :" + YMatrixScale + " XMatrixScale :" + XMatrixScale);
            }
        }
...
//        Log.d(TAG, "EncodeRenderHandler thread started:");
        synchronized (sync) {
...
//        Log.d(TAG, "EncodeRenderHandler thread finished:");
    }
