...
import com.couchbase.lite.store.*;
...
public class SQLiteViewStore implements ViewStore, QueryRowStore {
    ...
    public Status updateIndexes(List<ViewStore> inputViews) throws CouchbaseLiteException {
        ...
        try {
            ...
            SQLiteViewStore.AbstractMapEmitBlock emitBlock = new AbstractMapEmitBlock() {
                @Override
    ...
    private void emit(Object key, Object value, long sequence) throws JsonProcessingException {
        String valueJson;
