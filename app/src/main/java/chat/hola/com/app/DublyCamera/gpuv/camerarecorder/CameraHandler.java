...
public class CameraHandler extends Handler {
    ...
    private boolean zoomOut, zoomReset;
...
//                    if (DEBUG) Log.d(TAG, "wait for terminating of camera thread");
            ...
            switch (msg.what) {
                ...
                case MSG_CHANGE_ZOOM:
                    ...
                    if (thread != null) {
                        ...
                        thread.updateZoomLevel(zoomOut, zoomReset);
                    }
                    break;
    ...
    void zoomOut(boolean zoomOut, boolean zoomReset) {
        try {

            this.zoomOut = zoomOut;
            this.zoomReset = zoomReset;
            sendMessage(obtainMessage(MSG_CHANGE_ZOOM));
