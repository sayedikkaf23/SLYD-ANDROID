...
public class DuetVideoPreviewActivity extends AppCompatActivity
  ...
  @BindView(R.id.swipe_for_filter_video)
  View swipeFilterView;
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_duet_video_preview);
    ButterKnife.bind(this);

    if (ResultHolder.getType() != null && !chat.hola.com.app.DublyCamera.ResultHolder.getType()
        .equals("video")) {
      //video
    ...
    screenHeight = getIntent().getIntExtra("videoHeight", screenHeight);
    screenWidth = getIntent().getIntExtra("videoWidth", screenWidth);

    if (!imageFolder.exists() && !imageFolder.isDirectory()) imageFolder.mkdirs();

    movieWrapper = findViewById(R.id.layout_movie_wrapper);

    ViewGroup.LayoutParams params = movieWrapper.getLayoutParams();

    params.height = screenHeight;

    movieWrapper.setLayoutParams(params);

    params = swipeFilterView.getLayoutParams();
    params.height = screenHeight;

    swipeFilterView.setLayoutParams(params);
  ...
  public void next() {
    ...
    if (checkIfFiltersAppliedOnAnyVideoSegment()) {
      ...
      progressDialog = new ProgressDialog(DuetVideoPreviewActivity.this);
  ...
  public void filters() {
    if (filterEnabled) {
      ...
      Toast.makeText(DuetVideoPreviewActivity.this, getString(R.string.select_segment_colorfilter),
  ...
  private void initializeViewForColorFiltersVideo() {
    ...
    swipeFilterView.setOnTouchListener(new OnSwipeTouchListener(DuetVideoPreviewActivity.this) {
      ...
      public void onSwipeRight() {
        ...
        if (filterEnabled) {
          ...
          Toast.makeText(DuetVideoPreviewActivity.this,
  ...
  private void switchFilterToVideo(int filter) {
    ...
    switch (filter) {
      case 0:
        swipeFilterView.setBackgroundColor(Color.TRANSPARENT);
        filterColor = "";
        break;
      case 1:
        swipeFilterView.setBackgroundColor(Color.parseColor("#507FF489"));
        filterColor = "#807FF489";//1
        break;
      case 2:
        swipeFilterView.setBackgroundColor(Color.parseColor("#50dc070e"));
        filterColor = "#80dc070e";//6
        break;
      case 3:
        swipeFilterView.setBackgroundColor(Color.parseColor("#503362c1"));
        filterColor = "#803362c1"; //2
        break;
      case 4:
        swipeFilterView.setBackgroundColor(Color.parseColor("#50c13378"));
        filterColor = "#80c13378";//5
        break;
      case 5:
        swipeFilterView.setBackgroundColor(Color.parseColor("#5033c144"));
        filterColor = "#8033c144";//4
        break;
      case 6:
        swipeFilterView.setBackgroundColor(Color.parseColor("#50712989"));
  ...
  //private void updateFiltersVisibility(boolean notFromExit) {
  //
  ...
  private void prepareVideoPlaybackFiles(int maximumDuration) {
    ...
    float multiplier = screenWidth / maximumDuration;
    ...
    rvProgressBars.addOnItemTouchListener(
        new RecyclerItemClickListener(DuetVideoPreviewActivity.this, rvProgressBars,
    ...
    if (progressBarModel.isFilterSelected()) {
      ...
      if (progressBarModel.getFilterColor().isEmpty()) {
        applyVideoFilter(FilterType.createGlFilter(progressBarModel.getSelectedGlFilter(),
            DuetVideoPreviewActivity.this), progressBarModel.getVideoPath(), positionOfVideo, true,
            null, true, "");
      } else {
        ...
        applyVideoFilter(FilterType.createGlFilter(progressBarModel.getSelectedGlFilter(),
            DuetVideoPreviewActivity.this), progressBarModel.getVideoPath(), positionOfVideo, true,
            bitmap, true, progressBarModel.getFilterColor());
      }
    } else {
      if (progressBarModel.getFilterColor().isEmpty()) {
  ...
  private void setupFilterView() {
    ...
    filtersList.addOnItemTouchListener(
        new RecyclerItemClickListener(DuetVideoPreviewActivity.this, filtersList,
            new RecyclerItemClickListener.OnItemClickListener() {
              @Override
              public void onItemClick(View view, final int position) {
                if (gpuPlayerView != null) {
  ...
  public void updateFiltersVisibility() {
    if (filterEnabled) {
      ...
      Toast.makeText(DuetVideoPreviewActivity.this, getString(R.string.select_segment_videofilter),
          Toast.LENGTH_SHORT).show();
    }
  }
