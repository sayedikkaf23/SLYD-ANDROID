...
public final class LiveQuery extends Query implements Database.ChangeListener {
     ...
     */
    private Future rerunUpdateFuture;
     ...
     */
    @InterfaceAudience.Public
    private void waitForRows() throws CouchbaseLiteException {
        start();
    ...
    /* package */ void update() {
        ...
        queryFuture = runAsyncInternal(new QueryCompleteListener() {
            ...
            public void completed(QueryEnumerator rowsParam, Throwable error) {
                if (error != null) {
                    for (LiveQuery.ChangeListener observer : observers) {
                    ...
                    if (rowsParam != null && !rowsParam.equals(rows)) {
                        ...
                        for (LiveQuery.ChangeListener observer : observers) {
                            ...
                            observer.changed(new LiveQuery.ChangeEvent(LiveQuery.this, rows));
                        }
                    }
                    lastError = null;
                }
