...
*
* */
public class MediaHistory_Sent extends Fragment {
...
//        refine.setVisibility(View.GONE);
        ...
        stickyHeader.setText(getString(R.string.string_284));
                                    ...
                                    if (pos == mMessageData.size() - 1) {
                                        ...
                                        try {
                                            stickyHeader.setText(
                                                    ...
                                                    Utilities.formatDate(Utilities.tsFromGmt(p.getTS())).substring(9, 24) + getString(R.string.space) + getString(R.string.string_204) + getString(R.string.space) + Utilities.formatDate(Utilities.tsFromGmt(mMessageData.get(pos + 1).getTS())).substring(9, 24));
        ...
        if (mMessageData.size() == 0) {
            ...
            notProducts.setText(getString(R.string.string_285));
