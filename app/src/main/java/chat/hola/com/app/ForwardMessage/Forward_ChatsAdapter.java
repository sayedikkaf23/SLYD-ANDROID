...
//    private Typeface tf;
     ...
     */
    public Forward_ChatsAdapter(Context mContext, ArrayList<ChatlistItem> mListData) {
...
//            vh.newMessage.setTypeface(tf, Typeface.NORMAL);
            ...
            try {
                ...
                if ((chat.getNewMessageTime().substring(0, 8)).equals((Utilities.tsInGmt().substring(0, 8)))) {
                    ...
                    vh.newMessageDate.setText(R.string.string_207);//todo getString() cannot be applied
                } else if ((Integer.parseInt((Utilities.tsInGmt().substring(0, 8))) - Integer.parseInt((chat.getNewMessageTime().substring(0, 8)))) == 1) {


                    vh.newMessageDate.setText(R.string.string_208);//todo getString() cannot be applied
                ...
                if (chat.hasNewMessage()) {
                    ...
                    vh.newMessageCount.setText(R.string.double_inverted_comma);//todo getString() cannot be applied
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (mContext != null) {
                    ((ActivityForwardMessage) mContext).showNoSearchResults(constraint, mFilteredListData.size() == mOriginalListData.size(), 2);
                }
