...
class RevisionUtils {
    ...
    static Map<String, Object> makeRevisionHistoryDict(List<RevisionInternal> history) {
        if (history == null) {
            return null;
        }
    ...
    static byte[] asCanonicalJSON(RevisionInternal rev) {
        return asCanonicalJSON(rev.getProperties());
    }

    private static List<String> specialKeysToRemove = Arrays.asList(
            "_id",
            "_rev",
            "_deleted",
            "_revisions",
    ...
    private static List<String> specialKeysToLeave = Arrays.asList(
            "_attachments",
            "_removed");
     ...
     */
    @InterfaceAudience.Private
    static byte[] asCanonicalJSON(Map<String, Object> props) {
        if (props == null) {
            return null;
        }
     ...
     */
    @InterfaceAudience.Private
    static String generateRevID(byte[] json, boolean deleted, String prevID) {
