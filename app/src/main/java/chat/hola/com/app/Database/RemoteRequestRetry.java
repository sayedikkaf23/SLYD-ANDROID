...
public class RemoteRequestRetry<T> implements CustomFuture<T> {
    ...
    private static int MAX_RETRIES = 3;  // total number of attempts = 4 (1 initial + MAX_RETRIES)
    private static int RETRY_DELAY_MS = 4 * 1000; // 4 sec

    ////////////////////////////////////////////////////////////
    // Member variables
    ////////////////////////////////////////////////////////////
    private ScheduledExecutorService workExecutor;
    private ExecutorService requestExecutor;  // must have more than one thread
    ...
    private RemoteRequestCompletion onCompletionCaller;
    private RemoteRequestCompletion onPreCompletionCaller;
    ...
    private Map<Future, CancellableRunnable> runnables = new HashMap<Future, CancellableRunnable>();
    ...
    private RemoteRequestRetry.RemoteRequestType requestType;
    // for Retry task
     ...
     */
    CustomFuture submit(boolean gzip) {
    ...
    void setOnPreCompletionCaller(RemoteRequestCompletion onPreCompletionCaller) {
        this.onPreCompletionCaller = onPreCompletionCaller;
    }

    void setDontLog404(boolean dontLog404) {
