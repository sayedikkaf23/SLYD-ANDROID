...
public class PreviewFragmentVideoActivity extends AppCompatActivity
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (!ResultHolder.getType().equals("video")) {
      //video
    ...
    prepareVideoPlaybackFiles(getIntent().getIntExtra("maximumDuration", 60),
        getIntent().getBooleanExtra("captured", true));
  ...
  public void next() {
    ...
    if (checkIfFiltersAppliedOnAnyVideoSegment()) {
      ...
      progressDialog = new ProgressDialog(PreviewFragmentVideoActivity.this);
  ...
  public void filters() {
    if (filterEnabled) {
      ...
      Toast.makeText(PreviewFragmentVideoActivity.this,
  ...
  private void initializeViewForColorFiltersVideo() {
    ...
    view_filter.setOnTouchListener(new OnSwipeTouchListener(PreviewFragmentVideoActivity.this) {
  ...
  private void startNextActivity() {
    ...
    switch (ResultHolder.getCall()) {
      ...
      default:
        ...
        //                Log.d("log1---->",recordedVideoFiles.get(0));
  ...
  private void addMediaToBePlayed(String url, int durationInMs, ProgressBarModel progressBarModel) {
    ...
    if (progressBarModel.isFilterSelected()) {
      ...
      gpuPlayerView.setGlFilter(FilterType.createGlFilter(progressBarModel.getSelectedGlFilter(),
          PreviewFragmentVideoActivity.this));
    } else {
  ...
  private void startPlayback() {
    try {
      ...
      if (audioFile != null) {
        player = MediaPlayer.create(PreviewFragmentVideoActivity.this, Uri.parse(audioFile));
  ...
  private void prepareVideoPlaybackFiles(int maximumDuration, boolean capturedVideo) {
    ...
    rvProgressBars.addOnItemTouchListener(
        new RecyclerItemClickListener(PreviewFragmentVideoActivity.this, rvProgressBars,
    ...
    if (progressBarModel.isFilterSelected()) {
      ...
      if (progressBarModel.getFilterColor().isEmpty()) {
        applyVideoFilter(FilterType.createGlFilter(progressBarModel.getSelectedGlFilter(),
            PreviewFragmentVideoActivity.this), progressBarModel.getVideoPath(), positionOfVideo,
            true, null, true, "");
      } else {
  ...
  private void setupFilterView() {
    ...
    filtersList.addOnItemTouchListener(
        new RecyclerItemClickListener(PreviewFragmentVideoActivity.this, filtersList,
            new RecyclerItemClickListener.OnItemClickListener() {
              @Override
              public void onItemClick(View view, final int position) {
                if (gpuPlayerView != null) {
