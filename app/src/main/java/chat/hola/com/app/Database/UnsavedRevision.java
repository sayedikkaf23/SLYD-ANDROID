 ...
 */
 final class UnsavedRevision extends Revision {
    ...
    @InterfaceAudience.Private
     UnsavedRevision(Document document, SavedRevision parentRevision) {
     ...
     */
    @InterfaceAudience.Public
    private void setAttachment(String name, String contentType, InputStream contentStream) {
    ...
    private void addAttachment(Attachment attachment, String name) {
