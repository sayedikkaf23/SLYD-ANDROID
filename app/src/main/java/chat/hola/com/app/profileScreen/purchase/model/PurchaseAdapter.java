package chat.hola.com.app.profileScreen.purchase.model;
...
public class PurchaseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  @Inject
  public PurchaseAdapter(Context context, List<Data> data) {
      ...
      if (position != -1) {
        ...
        switch (holder.getItemViewType()) {
          case 0:
            ...
            //holder1.ivLock.setVisibility(data.getPurchased() ? View.GONE :  View.VISIBLE);
