...
import chat.hola.com.app.home.profile.ProfileContract;
...
public class LiveUsersPresenter implements LiveUsersContract.Presenter {
    ...
    @Override
    public void attachView(LiveUsersContract.View view) {
        this.broadcasterView = view;
    }
                    ...
                    public void onNext(Response<ResponseBody> responseBodyResponse) {
                        ...
                        try {
                            if (code == 200) {
                                ...
                                isLastPage = liveBroadCaster.getData().getStreams()==null || liveBroadCaster.getData().getStreams().size() < PAGE_SIZE;
