...
import chat.hola.com.app.live_stream.MQtt.CustomMQtt.ClientComms;
...
import chat.hola.com.app.live_stream.MQtt.CustomMQtt.MqttPingSender;
...
class AlarmPingSender implements MqttPingSender {
    ...
    public void start() {
        ...
        pendingIntent = PendingIntent.getBroadcast(service, 0, new Intent(
                action), PendingIntent.FLAG_MUTABLE);
