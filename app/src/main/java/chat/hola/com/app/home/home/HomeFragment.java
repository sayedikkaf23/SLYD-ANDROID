...
public class HomeFragment extends DaggerFragment
    implements HomeContract.View, ClickListner, ActionListner, ItemAdapter.ItemListener,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mPresenter.callSocialApi(page, pageSize, true, false, false);
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                mPresenter.callSocialApi(page, pageSize, false, true, false);
            }
        });
        ...
        try {
            Glide.with(mActivity)
                .load(sessionManager.getUserProfilePic()
                    .replace("upload/", Constants.PROFILE_PIC_SHAPE))
                .asBitmap()
...
//        startActivity(new Intent(mActivity, UserActivitiesActivity.class));
...
//        mActivity.openDrawer();
    ...
    public void onClick(DialogInterface dialogInterface, int which) {
        ...
        confirm.setPositiveButton(R.string.confirm,
            (dialog, w) -> mPresenter.reportPost(position, postTobeShared.getPostId(),
                arrayAdapter.getItem(which), arrayAdapter.getItem(which)));
...
//                            .putExtra("commentsCount", commentsCount), COMMENT_COUNT);
    ...
    public void setDataList(List<Data> data, boolean entirelyNewList, boolean refreshRequest,
        boolean refreshOnNewPostCreated) {
            ...
            rvList.post(() -> {
                try {
                    ...
                    if (viewHolder != null) {
                        ...
                        videoItem.setActive(viewHolder.itemView, 0, refreshOnNewPostCreated);
                    }
        ...
        if (position >= 0) {
            if (dataList != null && !dataList.isEmpty()) {
                ...
                try {
                    ...
                    double ratio =
                        ((double) Integer.parseInt(dataList.get(position).getImageUrl1Height()))
    ...
    public void getMessage(JSONObject object) {
        try {
            if (object.getString("eventName").equals("postCompleted")) {
                ...
                //    }
                //
                //    mPresenter.callSocialApi(page, pageSize, false, true,true);
                //}, 5000);
...
//            commentsAdded++;
    ...
    public void sendTipSuccess(Data data, String coin, int position) {
        ...
        dataList.get(position).setTipsAmount(data.getTipsAmount()+Double.valueOf(coin));
        socialDetailAdapter.notifyItemChanged(position);
