...
public class CommentTextView extends LinearLayout implements View.OnClickListener {
  ...
  private CommentTextView.OnExpandStateChangeListener mListener;
  ...
  public void onClick(View view) {
    ...
    if (view.getId() == R.id.tvToggle) {
      ...
      if (mCollapsedStatus != null && commentId != null) {
        mCollapsedStatus.put(commentId, mCollapsed);
      }
      ...
      Animation animation;
      if (mCollapsed) {
        animation = new CommentTextView.ExpandCollapseAnimation(this, getHeight(),
            mCollapsedHeight);
      } else {
        animation = new CommentTextView.ExpandCollapseAnimation(this, getHeight(),
      ...
      animation.setAnimationListener(new Animation.AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
          ...
          // notify the listener
          if (mListener != null && commentId != null) {

            mListener.onExpandStateChanged(commentId, mCollapsed);
          }
        }
  ...
  public void setOnExpandStateChangeListener(
      @Nullable CommentTextView.OnExpandStateChangeListener listener) {
    mListener = listener;
  }
  ...
  public void setText(@Nullable CharSequence text,
      @NonNull HashMap<String, Boolean> collapsedStatus, String commentId,
      TypefaceManager typefaceManager) {
    mCollapsedStatus = collapsedStatus;
    this.commentId = commentId;
    boolean isCollapsed;
    if (collapsedStatus.containsKey(commentId)) {
      isCollapsed = collapsedStatus.get(commentId);
    } else {
      isCollapsed = true;
    }
    clearAnimation();
  ...
  public interface OnExpandStateChangeListener {
     ...
     *
     * @param commentId - id of the comment being expanded/collapsed
     * @param isCollapsed - true if the post tile has been collapsed
     */
    void onExpandStateChanged(String commentId, boolean isCollapsed);
  }
}