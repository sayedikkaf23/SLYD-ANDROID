...
class RemoteBulkDownloaderRequest extends RemoteRequest implements MultipartReaderDelegate {

    @InterfaceAudience.Private
    interface BulkDownloaderDocument {
    ...
    private RemoteBulkDownloaderRequest.BulkDownloaderDocument _onDocument;
