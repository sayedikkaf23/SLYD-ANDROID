...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public static final String AUTHORITY = "chat.howdoo.com.howdoo.documents";
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        // Add Home directory
        File homeDir =  AppController.getInstance().getApplicationContext().getExternalFilesDir(null);
