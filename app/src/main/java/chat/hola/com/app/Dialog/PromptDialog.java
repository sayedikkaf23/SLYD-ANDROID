...
/**
 * Dialog to show for success,error,info,help,warning on receiving the resonse of the various apis
 */
...
public class PromptDialog extends Dialog {
    ...
    private void initView() {
        ...
        mTitleTv.setTypeface(tf, Typeface.NORMAL);
        mContentTv.setTypeface(tf, Typeface.NORMAL);
        mPositiveBtn.setTypeface(tf, Typeface.NORMAL);
...
//          super.dismiss();
            ...
            Context context = ((ContextWrapper) mDialogView.getContext()).getBaseContext();
