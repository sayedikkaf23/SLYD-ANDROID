 ...
 * </p>
 */
public class MqttService extends JobIntentService implements MqttTraceHandler {//, ContentObserver {
    NotificationManager mNotificationManager;
    // Identifier for Intents, log messages, etc..
    static final String TAG = BuildConfig.APPLICATION_ID + ".MqttService";
    ...
    public IMqttDeliveryToken publish(String clientHandle, String topic,
        ...
        if (client != null)
            ...
            return (IMqttDeliveryToken) client.publish(topic, message, invocationContext, activityToken);
...
//     */
    ...
    protected void onHandleWork(@NonNull Intent intent) {
        ...
        if (mqttServiceBinder != null && mqttServiceBinder.getActivityToken() == null) {
            String activityToken = intent
                    .getStringExtra(MqttServiceConstants.CALLBACK_ACTIVITY_TOKEN);
            mqttServiceBinder.setActivityToken(activityToken);
