...
import chat.hola.com.app.profileScreen.paid.model.PaidAdapter;
...
public class PaidFragment extends DaggerFragment
    implements PaidContract.View, PaidAdapter.ClickListner {

  @Inject
  PaidPresenter presenter;
  @Inject
  ...
  public void loadData() {
        PaidPresenter.page = 0;
        presenter.loadData(PaidPresenter.page * PaidPresenter.PAGE_SIZE, PaidPresenter.PAGE_SIZE,
            type.equals("nogrid"));
  }
  ...
  public void setupRecyclerView() {
    ...
    adapter = new PaidAdapter(getContext(), data);
    ...
    try {
      ...
      if (isMine) {
        ...
        if (isEmpty) {
          ...
          tvEmpty.setText(getResources().getString(R.string.no_paid_posts));
        }
      } else {
