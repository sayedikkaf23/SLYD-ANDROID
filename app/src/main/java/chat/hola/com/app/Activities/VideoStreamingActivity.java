...
public class VideoStreamingActivity extends AppCompatActivity implements Player.EventListener {
    ...
    private static final String TAG = VideoStreamingActivity.class.getSimpleName();
