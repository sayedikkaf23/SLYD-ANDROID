...
/**
 * Created by moda on 14/09/17.
 */

public class ReplyMessageInfo extends AppCompatActivity implements OnMapReadyCallback {
...
//        title.setTypeface(tf, Typeface.BOLD);
        ...
        collapsingToolbarLayout.setExpandedTitleColor(ContextCompat.getColor(ReplyMessageInfo.this, R.color.transparent));
        collapsingToolbarLayout.setCollapsedTitleTextColor(ContextCompat.getColor(ReplyMessageInfo.this, R.color.color_white));
    ...
    private void minimizeCallScreen(JSONObject obj) {
        try {
            Intent intent = new Intent(ReplyMessageInfo.this, ChatMessageScreen.class);
                            ...
                            case 3:
                                ...
                                try {
                                    Glide
                                            ...
                                            .bitmapTransform(new CenterCrop(ReplyMessageInfo.this), new BlurTransformation(ReplyMessageInfo.this, 5))
                        ...
                        if (downloadStatus == 1) {
                            ...
                            if (messageContent != null) {
                                ...
                                try {
                                    ...
                                    if (ActivityCompat.checkSelfPermission(ReplyMessageInfo.this, Manifest.permission.READ_EXTERNAL_STORAGE)
...
//                                .crossFade()
                                                    ...
                                                    .listener(new RequestListener<String, GlideDrawable>() {
                                                        ...
                                                        public boolean onResourceReady(GlideDrawable resource, String model, Target<GlideDrawable> target, boolean isFromMemoryCache, boolean isFirstResource) {
                                                            imageView.setBackgroundColor(ContextCompat.getColor(ReplyMessageInfo.this, R.color.color_white));
                                        ...
                                        imageView.setImageDrawable(ContextCompat.getDrawable(ReplyMessageInfo.this, R.drawable.chat_white_circle));
                                        imageView.setBackgroundColor(ContextCompat.getColor(ReplyMessageInfo.this, R.color.color_white));
                            ...
                            try {
                                Glide
                                        ...
                                        .bitmapTransform(new CenterCrop(ReplyMessageInfo.this), new BlurTransformation(ReplyMessageInfo.this))
                    ...
                    case 6: {
                        ...
                        try {
                            ...
                            Glide.with(ReplyMessageInfo.this)
                                    .load(messageContent)
                                    .diskCacheStrategy(DiskCacheStrategy.SOURCE)
                                    .into(stickerImage);
...
//                                .crossFade()
                                                    ...
                                                    .listener(new RequestListener<String, GlideDrawable>() {
                                                        ...
                                                        @Override
                                                        public boolean onResourceReady(GlideDrawable resource, String model, Target<GlideDrawable> target, boolean isFromMemoryCache, boolean isFirstResource) {
                                                            doodleImage.setBackgroundColor(ContextCompat.getColor(ReplyMessageInfo.this, R.color.color_white));
                                        ...
                                        doodleImage.setImageDrawable(ContextCompat.getDrawable(ReplyMessageInfo.this, R.drawable.chat_white_circle));
                                        doodleImage.setBackgroundColor(ContextCompat.getColor(ReplyMessageInfo.this, R.color.color_white));
            ...
            try {
                ...
                if (tempDeliveryTime != null) {
                    ...
                    if (current_date.equals(tempDeliveryTime.substring(0, 8))) {
                        ...
                        tempDeliveryTime = Utilities.convert24to12hourformat(tempDeliveryTime.substring(8, 10) + ":" + tempDeliveryTime.substring(10, 12));
                        ...
                        String last = Utilities.convert24to12hourformat(tempDeliveryTime.substring(8, 10) + ":" + tempDeliveryTime.substring(10, 12));
            ...
            try {
                ...
                if (tempReadTime != null) {
                    ...
                    if (current_date.equals(tempReadTime.substring(0, 8))) {
                        ...
                        tempReadTime = Utilities.convert24to12hourformat(tempReadTime.substring(8, 10) + ":" + tempReadTime.substring(10, 12));
                        ...
                        String last = Utilities.convert24to12hourformat(tempReadTime.substring(8, 10) + ":" + tempReadTime.substring(10, 12));
        ...
        switch (type) {
            ...
            case 2: {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        chatBackground.setImageDrawable(null);
                        chatBackground.setBackgroundColor(ContextCompat.getColor(ReplyMessageInfo.this, R.color.color_white));
