...
public class DubListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    @Inject
    public DubListAdapter(List<Dub> dubs, Activity mContext, TypefaceManager typefaceManager) {
        this.dubs = dubs;
    ...
    public void onBindViewHolder(final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.ivLike.setOnClickListener(v -> clickListner.like(position, dub.isMyFavourite() != 1));
    }
