...
public class PopularFragment extends DaggerFragment
        implements PopularContract.View, ClickListner, ActionListner, ItemAdapter.ItemListener,
        ...
        OverlayProfileInfoResult, chat.hola.com.app.comment.model.ClickListner, FollowerAdapter.OnFollowUnfollowClickCallback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mPresenter.subscribeSavedObserver();
        ...
        mPresenter.callSocialApi(page, pageSize, true, false);
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                mPresenter.callSocialApi(page, pageSize, true, true);
            }
        });
    ...
    public void liked(boolean likeRequest, boolean hasError, String postId) {
        ...
        if (hasError) {
            ...
            for (int i = 0; i < dataList.size(); i++) {
                ...
                if (dataList.get(i).getPostId() != null && dataList.get(i).getPostId().equals(postId)) {
                    if (likeRequest) {
...
//        mActivity.drawerLayout.setDrawerLockMode(DrawerLayout.LOCK_MODE_UNLOCKED);
    ...
    public void send(int position) {
        ...
        if (friends != null && !friends.isEmpty()) {
            ...
            Toast.makeText(mActivity, getResources().getString(R.string.please_add_friends),
...
//                            .putExtra("commentsCount", commentsCount), COMMENT_COUNT);
                ...
                if (postIds.containsKey(data.get(i).getPostId())) {
                    ...
                    try {
                        ...
                        mList.set(postIds.get(data.get(i).getPostId()),
                                ItemFactory.createItem(getActivity(), mVideoPlayerManager, data.get(i)));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                } else {
    ...
    public void location(Data data) {
        startActivity(new Intent(mActivity, TrendingDetail.class).putExtra("placeId", data.getPlaceId())
...
//        startActivity(intent);
                ...
                try {
                    ...
                    if (ratio > screenRatio) {
                        try {
                            ...
                            thumbnailUrl = Utilities.getModifiedThumbnailLinkForPosts(thumbnailUrl,dataList.get(position).getPurchased());
    ...
    public void getMessage(JSONObject object) {
        try {
            if (object.getString("eventName").equals("postCompleted")) {
                ...
                //    } catch (Exception ignore) {
                //    }
                //    mPresenter.callSocialApi(page, pageSize, false, true);
                //}, 1500);
            }
        } catch (JSONException e) {
            e.printStackTrace();
    ...
    public void sendTipSuccess(Data data, String coin, int position) {
        mediaPlayer.start();
        Toast.makeText(getActivity(), "Tip Sent to "+data.getUsername(), Toast.LENGTH_SHORT).show();
    ...
    public void downloadResult(String result, String filePath, boolean duet) {
        ...
        if (result == null) {
                        ...
                        if (OverlayConfig.OVERLAY_REQUIRED) {
                            if (postTobeShared.getMediaType1() == 1) {
                                if (filePath.endsWith(".gif")) {
                                    cancelDownloadDialog();
                                    Toast.makeText(mActivity, getString(R.string.media_downloaded, filePath),
                                            Toast.LENGTH_SHORT).show();
                                } else {
            ...
            if (getActivity() != null) {
                getActivity().
                        runOnUiThread(() -> Toast.makeText(mActivity, result, Toast.LENGTH_SHORT).show());
            }
        }
    }
