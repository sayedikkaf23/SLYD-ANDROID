...
public class TagAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public interface ClickListner {
    void onItemClick(int position, Data data, int type, View view);
  ...
  @Inject
  public TagAdapter(Context context, List<Data> data) {
    ...
    switch (holder.getItemViewType()) {
      case 0:
        ...
        holder1.ivImage.setOnClickListener(
            view -> clickListner.onItemClick(position, data, data.getMediaType1(), view));

        holder1.ibPlay.setOnClickListener(
            v -> clickListner.onItemClick(position, data, data.getMediaType1(), v));
      ...
      case 1:
        ...
        holder2.ibComment.setOnClickListener(v -> clickListner.onCommentClick(data.getPostId()));
