package chat.hola.com.app.motionView.motionviews.widget;
...
import chat.hola.com.app.motionView.multitouch.MoveGestureDetector;
import chat.hola.com.app.motionView.multitouch.RotateGestureDetector;
...
public class MotionView extends FrameLayout {
    ...
    public void removeEntity(@Nullable MotionEntity entity) {
        if (entity == null) {
            return;
        }
        if (entities.remove(entity)) {
