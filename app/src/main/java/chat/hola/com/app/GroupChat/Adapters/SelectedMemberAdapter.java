...
public class SelectedMemberAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public SelectedMemberAdapter(Context mContext, ArrayList<Forward_ContactItem> mListData) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v1 = inflater.inflate(R.layout.gc_selected_contact_item, viewGroup, false);
    ...
    private void configureViewHolderSelectedMember(final ViewHolderSelectedMember vh, int position) {
        ...
        if (forwardContactItem != null) {
...

            {
                ...
                try {
                    ...
                    vh.contactImage.setImageDrawable(TextDrawable.builder()
                            ...
                            .fontSize(12 * density) /* size in px */
                            .bold()
                            .toUpperCase()
                            .endConfig()
            ...
            vh.removeContact.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    ((CreateGroup) mContext).removeMember(forwardContactItem.getContactUid());
