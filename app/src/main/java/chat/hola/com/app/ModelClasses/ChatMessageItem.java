...
public class ChatMessageItem {
    ...
    private String message, messageDateOverlay, messageType, id, fromName,
            videoPath, imagepath, audioPath, ts, date, deliveryStatus,
            contactInfo,amount,transferStatus,transferStatusText,transactionId;
    private boolean isSelf;

    /* for missed call*/
    private String callId,typeOfCall;
