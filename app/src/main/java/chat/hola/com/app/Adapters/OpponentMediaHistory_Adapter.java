...
public class OpponentMediaHistory_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public OpponentMediaHistory_Adapter(Context mContext, ArrayList<Media_History_Item> mListData) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case IMAGE:
                v1 = inflater.inflate(R.layout.opponent_media_shared_image, viewGroup, false);
                viewHolder = new ViewHolderImageMedia(v1);

                break;

            default:
                v1 = inflater.inflate(R.layout.opponent_media_shared_video, viewGroup, false);
                    ...
                    if (media.getDownloadStatus() == 0) {
                        ...
                        try {
                             ...
                             */
                                ...
                                vh.fnf.setTypeface(tf, Typeface.NORMAL);
                                vh.fnf.setText(R.string.string_211);
                                vh.image.setImageDrawable(null);
                                vh.image.setBackgroundColor(ContextCompat.getColor(mContext, R.color.color_white));
