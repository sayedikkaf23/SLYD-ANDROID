...
import chat.hola.com.app.DublyCamera.gpuv.camerarecorder.capture.MediaAudioEncoder;
import chat.hola.com.app.DublyCamera.gpuv.camerarecorder.capture.MediaEncoder;
import chat.hola.com.app.DublyCamera.gpuv.camerarecorder.capture.MediaMuxerCaptureWrapper;
import chat.hola.com.app.DublyCamera.gpuv.camerarecorder.capture.MediaVideoEncoder;
import chat.hola.com.app.DublyCamera.gpuv.egl.GlPreviewRenderer;
...
//            Log.d("TAG", "RuntimeException: stop() is called immediately after start()");
    ...
    public void zoomOut(boolean zoomOut,boolean reset) {


        try {
            cameraHandler.zoomOut(zoomOut,reset);
