package chat.hola.com.app.cameraActivities.utils;
    ...
    public static File getOutputMediaFile(Context context, @CameraConfiguration.MediaAction int mediaAction) {
        ...
        if (mediaAction == CameraConfiguration.MEDIA_ACTION_PHOTO) {
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                mediaStorageDir = new File(context.getExternalFilesDir(null)  + "/" + context.getResources().getString(R.string.app_name) + "/Media/");

            } else {

                mediaStorageDir = new File(context.getFilesDir() + "/" + context.getResources().getString(R.string.app_name) + "/Media/");
            }
