...
public class StoryStatusView extends LinearLayout {
    ...
    public void setDuartionAt(int i,long duration){
        animators.remove(i);
        animators.add(i,createAnimator(i,duration));
    }

    public void setStoryDurationArray(long[] duration){
        animators.clear();
        for (int i = 0; i < progressBars.size(); i++) {
            animators.add(createAnimator(i, duration[i]));
        }
    ...
    public void playStoryAt(int counter){
        animators.get(counter).start();
    }
