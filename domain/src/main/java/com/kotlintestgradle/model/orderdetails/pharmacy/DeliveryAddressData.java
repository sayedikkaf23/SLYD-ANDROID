...
public class DeliveryAddressData implements Parcelable {
	...
	protected DeliveryAddressData(Parcel in) {
	...
	public static final Creator<DeliveryAddressData> CREATOR = new Creator<DeliveryAddressData>() {
		@Override
		public DeliveryAddressData createFromParcel(Parcel in) {
			return new DeliveryAddressData(in);
		}

		@Override
		public DeliveryAddressData[] newArray(int size) {
			return new DeliveryAddressData[size];
		}
	};
