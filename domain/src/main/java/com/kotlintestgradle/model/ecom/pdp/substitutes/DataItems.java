...
public class DataItems implements Parcelable {
	...
	private FinalPriceLists finalPriceList;

	public DataItems(Offers offers, Images images, String parentProductId, String childProductId,
					 String manufactureName, Supplier supplier, boolean outOfStock, String currencySymbol,
					 String currency, String brandTitle, String productName, FinalPriceLists finalPriceList) {
		this.offers = offers;
		this.images = images;
	...
	protected DataItems(Parcel in) {
		...
		finalPriceList = in.readParcelable(FinalPriceLists.class.getClassLoader());
	}
	...
	public void setFinalPriceList(FinalPriceLists finalPriceList){
		this.finalPriceList = finalPriceList;
	}

	public FinalPriceLists getFinalPriceList(){
