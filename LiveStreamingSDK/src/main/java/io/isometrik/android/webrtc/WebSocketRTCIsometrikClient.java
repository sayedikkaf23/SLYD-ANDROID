...
import io.isometrik.android.webrtc.WebSocketChannelIsometrikClient.WebSocketChannelEvents;
 ...
 */
public class WebSocketRTCIsometrikClient implements AppRTCClient, WebSocketChannelEvents {
  ...
  private WebSocketChannelIsometrikClient wsClient;
  ...
  public WebSocketRTCIsometrikClient(SignalingEvents events) {
    this.events = events;
  ...
  private void connectToRoomInternal() {
    ...
    wsClient = new WebSocketChannelIsometrikClient(handler, this, connectionParameters.roomId, connectionParameters.mode, connectionParameters.token);
  ...
  // All events are called by WebSocketChannelIsometrikClient on a local looper thread
  // (passed to WebSocket client constructor).
  @Override
  public void onWebSocketMessage(final String msg) {
    if (wsClient.getState() != WebSocketChannelIsometrikClient.WebSocketConnectionState.CONNECTED) {
