...
import io.isometrik.android.webrtc.apprtc.StreamingControls;
import org.webrtc.RendererCommon;
import org.webrtc.SurfaceViewRenderer;

/**
 * Created by moda on 20.10.2017.
 */

public interface IWebRTCClient extends StreamingControls.OnCallEvents {
     ...
     */
    void init(String url, String streamId, String mode, String token, Intent intent,boolean participantList);
     ...
     */
    void switchCamera(boolean rearCameraActive);
