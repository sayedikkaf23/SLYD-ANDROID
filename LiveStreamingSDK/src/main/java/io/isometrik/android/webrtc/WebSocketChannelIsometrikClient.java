...
import io.isometrik.android.webrtc.apprtc.util.AsyncHttpURLConnection;
import io.isometrik.android.webrtc.apprtc.util.AsyncHttpURLConnection.AsyncHttpEvents;
import java.net.URI;
...
public class WebSocketChannelIsometrikClient {
  ...
  public WebSocketChannelIsometrikClient(Handler handler, WebSocketChannelEvents events, String roomID, String streamMode, String token) {
  ...
  public void register() {
    ...
    JSONObject json = new JSONObject();
    try {
      json.put(WebSocketRTCIsometrikClient.COMMAND, streamMode);
      json.put(WebSocketRTCIsometrikClient.STREAM_ID, roomID);
      json.put(WebSocketRTCIsometrikClient.TOKEN_ID, token);
