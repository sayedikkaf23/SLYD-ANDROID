...
/**
 * Fragment for streaming controls.
 */
public class StreamingControls extends Fragment {
  ...
  public void onStart() {
    ...
    if (args != null) {
      ...
      captureSliderEnabled = videoCallEnabled
          && args.getBoolean(Constants.EXTRA_VIDEO_CAPTUREQUALITYSLIDER_ENABLED, false);
    }
    if (!videoCallEnabled) {
