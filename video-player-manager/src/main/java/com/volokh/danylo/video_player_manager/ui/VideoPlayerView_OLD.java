 ...
 */
//
//public class VideoPlayerView_OLD extends ScalableTextureView
...
//     * If you need to use it you should synchronize in on {@link VideoPlayerView_OLD#mReadyForPlaybackIndicator} in order to have a consistent state.
...
//    }
//
//    public VideoPlayerView_OLD(Context context) {
//        super(context);
//        initView();
//    }
//
//    public VideoPlayerView_OLD(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        initView();
//    }
//
//    public VideoPlayerView_OLD(Context context, AttributeSet attrs, int defStyleAttr) {
//        super(context, attrs, defStyleAttr);
//        initView();
//    }
//
//    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
//    public VideoPlayerView_OLD(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
