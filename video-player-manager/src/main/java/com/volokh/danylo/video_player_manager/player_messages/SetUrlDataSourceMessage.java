...
public class SetUrlDataSourceMessage extends SetDataSourceMessage{
    ...
    public SetUrlDataSourceMessage(VideoPlayerView videoPlayerView, String videoUrl, VideoPlayerManagerCallback callback,boolean videoMuted) {
    ...
    protected void performAction(VideoPlayerView currentPlayer) {
        currentPlayer.setDataSource(mVideoUrl,videoMuted);
    }
}
